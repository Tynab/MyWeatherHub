...
public class ZonesResponse
{
    ...
    public class Feature
    {
        ...
        public static explicit operator Zone(Feature feature) => new(feature?.Properties?.Key ?? string.Empty, feature?.Properties?.Name ?? string.Empty, feature?.Properties?.State ?? string.Empty);
